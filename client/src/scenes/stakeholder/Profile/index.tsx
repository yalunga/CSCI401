...
export default class StakeholderProfile extends React.Component<ProfileProps, ProfileState> {
  ...
  render() {
    const { user: { firstName, lastName, organization, phone }, isLoading } = this.state;
    return (
