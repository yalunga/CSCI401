...
class StudentProject extends React.Component<ProjectProps, ProjectState> {
    ...
    async componentDidMount() {
        ...
        await fetch(`${process.env.REACT_APP_API_URL}/projects/student/` + sessionStorage.getItem('email'))
        ...
        await fetch(`${process.env.REACT_APP_API_URL}/projects/` + this.state.project.projectId + '/students')
            .then(response => response.json())
            .then(data => this.setState({ students: data }))
            .catch(error => { console.log('no project assigned', error); });

        fetch(`${process.env.REACT_APP_API_URL}/projects/` + this.state.project.projectId + '/stakeholder')
            .then(response => response.json())
